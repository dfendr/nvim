local options = {
   ...
   -- netrw_banner = 0, -- disable that annoying Netrw banner
   ...
   -- netrw_liststyle = 3, -- treeview
    ...
    pumheight = 5,         -- max number of autocompletion options that will show
    relativenumber = false, -- Show relative numbers
    ruler = true,          -- Measures line/col
    scrolloff = 0,         -- Minimal number of lines viewable above/below cursor on scroll.
    shellcmdflag = "-c", -- Run commands from "!" mode in interactive mode (sources custom functions)
    ...
    spell = false,       -- Spellcheck on in non code text.
    ...
    termguicolors = true, -- Theme sets terminal colors.
    title = true,
